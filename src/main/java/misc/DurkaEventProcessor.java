...
public class DurkaEventProcessor {
    public static DurkaEventProcessor instance = null;
    ...
    public void processEvent(MessageReceivedEvent event) {
        ...
        if (voiceChannel != null) {
            connectTo(voiceChannel);                                         // Join the channel of the user
        }
    }
    ...
    public static DurkaEventProcessor getInstance() {
        if (instance == null) {
            instance = new DurkaEventProcessor();
        }
        return instance;
    }
